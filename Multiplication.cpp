...
*Description: multiplication class definitions for constructor, destructor, print and evaluate.
*/
#include <sstream>
#include <stdlib.h>
...
Multiplication::Multiplication(string ls, string rs, string branch):
